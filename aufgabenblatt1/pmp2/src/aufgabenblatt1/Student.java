...
public class Student implements Comparable<Student> {
   ...
   * Matrikelnummer wird erstellt im Konstruktor mit MatrikelnummerZaehler.
   */
   ...
   */
  private ArrayList<Pruefungsleistung> pruefungsleistungsListe;
   ...
   */
  public ArrayList<Pruefungsleistung> getPruefungsleistungsListe(){
