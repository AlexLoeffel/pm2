...
public class Lokfuehrer extends Thread {
  ...
  /**
   *  Richtung aus oder in ein Abstellgleis
   *  true = einfahrt, false = ausfahrt
   */
   ...
   * KONSTRUKTOR
   * 
   * @param rbf Arbeitsplatz des Lokfuehrers.
   * @param gleis Nummer seines Abstellgleises.
   * @param richtung Richtung aus oder in das Abstellgleis.
   */
